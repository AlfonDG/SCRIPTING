...
select opcion in ${opciones[@]};
	...
	do
		...
		"Alarma")
			...
			echo -n "Introduzca por favor las horas en formato HH: "

			read hora

			echo -n "Introduzca los minutos en formato MM: "
		...
		"Cronómetro")
			...
			echo -n "Pulsa una tecla y comenzaremos el cronómetro, recuerda que para parar el crono puedes pulsar Ctrl +c, tienes 10 segundos para picar ENTER: "

			read -t 10 teclaEnter

                        if [[ $teclaEnter -ne 0 ]]; then
				...
				echo "Cronómetro parado en $avanzar segundos"
